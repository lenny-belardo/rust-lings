...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        let mut team_1_statistics = Team {
            name: String::from(&team_1_name),
            goals_scored: team_1_score,
            goals_conceded: team_2_score,
        };

        let mut team_2_statistics = Team {
        ...
        scores.insert(team_1_name.clone(), team_1_statistics);
        scores.insert(team_2_name.clone(), team_2_statistics);
    }
    scores
}
